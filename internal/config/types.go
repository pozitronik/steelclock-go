...
type DirectDriverConfig struct {
	VID       string `json:"vid,omitempty"`       // Vendor ID (hex string, e.g. "1038")
	PID       string `json:"pid,omitempty"`       // Product ID (hex string, e.g. "1612")
	Interface string `json:"interface,omitempty"` // USB interface (default "mi_01")
}
