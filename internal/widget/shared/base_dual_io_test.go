...
func TestNewBaseDualIOWidget(t *testing.T) {
	...
	converter := NewByteRateConverter("Mbps")
	renderer := NewDualMetricRenderer(
		DualBarConfig{Direction: "horizontal", PrimaryColor: 255, SecondaryColor: 200},
		DualGraphConfig{HistoryLen: 30, PrimaryFill: 255, SecondaryFill: 200},
		DualGaugeConfig{},
		TextConfig{HorizAlign: "center", VertAlign: "center"},
	)
	...
	if widget.DisplayMode != DisplayModeText {
...
func TestSetValues(t *testing.T) {
	widget := createTestWidget(DisplayModeText)
...
func TestAddToHistory(t *testing.T) {
	widget := createTestWidget(DisplayModeGraph)
...
func TestIsGraphMode(t *testing.T) {
	tests := []struct {
		...
		{DisplayModeGraph, true},
		{DisplayModeGauge, false},
	}
...
func TestRender_BarMode(t *testing.T) {
	widget := createTestWidget(DisplayModeBar)
...
func TestRender_GaugeMode_Supported(t *testing.T) {
	widget := createTestWidgetWithGauge(DisplayModeGauge, true)
	widget.SetValues(500000, 1000000)
...
func TestRender_GaugeMode_NotSupported(t *testing.T) {
	widget := createTestWidgetWithGauge(DisplayModeGauge, false)
	widget.SetValues(500000, 1000000)
...
func TestAutoScale(t *testing.T) {
	widget := createTestWidgetAutoScale(DisplayModeBar)
...
func createTestWidget(mode DisplayMode) *BaseDualIOWidget {
	return createTestWidgetWithGauge(mode, false)
}

func createTestWidgetWithGauge(mode DisplayMode, supportsGauge bool) *BaseDualIOWidget {
	base := newMockWidgetBase(128, 40)
	converter := NewByteRateConverter("MB/s")
	renderer := NewDualMetricRenderer(
		DualBarConfig{Direction: "horizontal", PrimaryColor: 255, SecondaryColor: 200},
		DualGraphConfig{HistoryLen: 30, PrimaryFill: 255, SecondaryFill: 200},
		DualGaugeConfig{
...
func createTestWidgetAutoScale(mode DisplayMode) *BaseDualIOWidget {
	base := newMockWidgetBase(128, 40)
	converter := NewByteRateConverter("MB/s")
	renderer := NewDualMetricRenderer(
		DualBarConfig{Direction: "horizontal", PrimaryColor: 255, SecondaryColor: 200},
